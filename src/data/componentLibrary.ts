...
export const COMPONENT_PRESETS: ComponentPreset[] = [
...

  {
    ...
    category: 'Checkboxes',
    controlType: 77,
    parentClass: 'RscCheckbox',
    description: 'Native Arma 3 checkbox (CT_CHECKBOX). Toggleable control with checked/unchecked textures for each state.',
    defaultProperties: {
      type: 77,
      style: 0,
      default: 0,
  ...
  {
    id: 'rsccontrolsgroup',
    label: 'RscControlsGroup',
    category: 'Control Groups',
    controlType: 15,
    parentClass: 'RscControlsGroup',
    description: 'Native Arma 3 controls group (CT_CONTROLS_GROUP). Container with scrollable child area and themed scrollbars.',
    defaultProperties: {
      type: 15,
      style: 16,
      shadow: 0,
...

  {
    ...
    controlType: 0,
    parentClass: 'RscText',
    description: 'Native Arma 3 static text (CT_STATIC). Single-line text label with shadow. Base class for most text controls.',
    defaultProperties: {
      type: 0,
      style: 0,
      shadow: 1,
...

  {
    ...
    controlType: 0,
    parentClass: 'RscLine',
    description: 'Native Arma 3 line (CT_STATIC). Draws a diagonal line from top-left to bottom-right. Inherits RscText.',
    defaultProperties: {
      type: 0,
      style: 0x10 + 0x20 + 0x80,
      colorText: [1, 1, 1, 1],
      colorBackground: [0, 0, 0, 0],
      text: '',
    },
  ...
  {
    id: 'rscstructuredtext',
    label: 'RscStructuredText',
    category: 'HUD / Text',
    controlType: 13,
    parentClass: 'RscStructuredText',
    description: 'Native Arma 3 structured text (CT_STRUCTURED_TEXT). Rich text control supporting styled attributes via Structured Text format.',
    defaultProperties: {
      type: 13,
      style: 0,
      size: sizeExpr,
...

  {
    ...
    category: 'HUD / Text',
    controlType: 0,
    parentClass: 'RscFrame',
    description: 'Native Arma 3 frame (CT_STATIC). Decorative border frame with optional label text overlapping the top edge.',
    defaultProperties: {
      type: 0,
      style: 0x40,
      shadow: 2,
...

  {
    ...
    category: 'Lists & Selection',
    controlType: 5,
    parentClass: 'RscListBox',
    description: 'Native Arma 3 listbox (CT_LISTBOX). Scrollable list with selectable items, textures, and pulsating selection colors.',
    defaultProperties: {
      type: 5,
      style: 16,
      shadow: 0,
...

  {
    ...
    category: 'Lists & Selection',
    controlType: 4,
    parentClass: 'RscCombo',
    description: 'Native Arma 3 combo box (CT_COMBO). Dropdown menu with arrow textures, scrollable list, and expand/collapse sounds.',
    defaultProperties: {
      type: 4,
      style: 16 + 0x0200,
      shadow: 0,
...

  {
    ...
    category: 'Buttons',
    controlType: 1,
    parentClass: 'RscButton',
    description: 'Native Arma 3 button (CT_BUTTON). Base class for all button controls. Supports hover, focus, and press states with sound effects.',
    defaultProperties: {
      type: 1,
      style: 2,
      shadow: 2,
  ...
  {
    id: 'rscshortcutbutton',
    label: 'RscShortcutButton',
    category: 'Buttons',
    controlType: 16,
    parentClass: 'RscShortcutButton',
    description: 'Native Arma 3 shortcut button (CT_SHORTCUTBUTTON). Supports animated textures, keyboard shortcut display, and structured text.',
    defaultProperties: {
      type: 16,
      style: 0,
      default: 0,
      ...
      colorBackgroundFocused: [0.13, 0.54, 0.21, 1],
...

  {
    ...
    category: 'Buttons',
    controlType: 16,
    parentClass: 'RscButtonMenu',
    description: 'Native Arma 3 menu button. Modern button style used in escape display. Inherits from RscShortcutButton.',
    defaultProperties: {
      type: 16,
      style: 0x02 + 0x40 + 0xC0,
      default: 0,
      shadow: 0,
      font: 'RobotoCondensed',
      sizeEx: sizeExpr,
...

  {
    ...
    category: 'Visuals & Inputs',
    controlType: 0,
    parentClass: 'RscPicture',
    description: 'Native Arma 3 picture (CT_STATIC). Displays a PAA image. Set texture path in the text property.',
    defaultProperties: {
      type: 0,
      style: 0x30,
      font: 'TahomaB',
  ...
  {
    id: 'rscpicturekeepaspect',
    label: 'RscPictureKeepAspect',
    category: 'Visuals & Inputs',
    controlType: 0,
    parentClass: 'RscPictureKeepAspect',
    description: 'Native Arma 3 picture with aspect ratio preservation (CT_STATIC + ST_KEEP_ASPECT_RATIO).',
    defaultProperties: {
      type: 0,
      style: 0x30 + 0x800,
      font: 'TahomaB',
...

  {
    ...
    category: 'Visuals & Inputs',
    controlType: 0,
    parentClass: 'RscVideo',
    description: 'Native Arma 3 video player (CT_STATIC). Plays .OGV video files with optional autoplay and looping. Inherits RscPicture.',
    defaultProperties: {
      type: 0,
      style: 0x30,
      font: 'TahomaB',
  ...
  {
    id: 'rscvideokeepaspect',
    label: 'RscVideoKeepAspect',
    category: 'Visuals & Inputs',
    controlType: 0,
    parentClass: 'RscVideoKeepAspect',
    description: 'Native Arma 3 video player with aspect ratio preservation (CT_STATIC + ST_KEEP_ASPECT_RATIO).',
    defaultProperties: {
      type: 0,
      style: 0x30 + 0x800,
      font: 'TahomaB',
...

  {
    ...
    controlType: 2,
    parentClass: 'RscEdit',
    description: 'Native Arma 3 edit box (CT_EDIT). Editable text input with selection highlight and autocomplete support.',
    defaultProperties: {
      type: 2,
      style: 0x40,
      font: 'RobotoCondensed',
...

  {
    ...
    category: 'Visuals & Inputs',
    controlType: 3,
    parentClass: 'RscSlider',
    description: 'Native Arma 3 slider (CT_SLIDER). Horizontal slider for selecting a value from a range. Deprecated in favor of CT_XSLIDER.',
    defaultProperties: {
      type: 3,
      style: 0x0400,
      shadow: 0,
...

  {
    ...
    category: 'Visuals & Inputs',
    controlType: 43,
    parentClass: 'RscXSliderH',
    description: 'Native Arma 3 horizontal XSlider (CT_XSLIDER). Modern horizontal slider with arrow, thumb, and border textures.',
    defaultProperties: {
      type: 43,
      style: 0x0400 + 0x0100,
      shadow: 0,
...
// =============================================================================
// ARMA NATIVE vs LIFE FRAMEWORK
// =============================================================================

export const ARMA_PRESETS = COMPONENT_PRESETS.filter(p => !p.id.startsWith('life_'));
export const LIFE_PRESETS = COMPONENT_PRESETS.filter(p => p.id.startsWith('life_'));
...
export function getPresetsByCategory(source?: 'arma' | 'life'): Record<string, ComponentPreset[]> {
  const list = source === 'arma' ? ARMA_PRESETS : source === 'life' ? LIFE_PRESETS : COMPONENT_PRESETS;
